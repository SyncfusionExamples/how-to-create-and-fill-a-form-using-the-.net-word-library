# How to Create and Fill a Form Using the .NET Word Library
A quick start project that shows how to create and fill a form in using the Syncfusion&reg; [.NET&nbsp;Word library](https://www.syncfusion.com/document-processing/word-framework/net/word-library?utm_source=github&utm_medium=listing&utm_campaign=github-docio-video-examples) (DocIO).
...
- **Documentation:** [Content Controls](https://help.syncfusion.com/file-formats/docio/working-with-content-controls?utm_source=github&utm_medium=listing&utm_campaign=github-docio-video-examples)
